  ...
  if(cmd === `${prefix}serverinfo`){
   ...
   if (cmd === `${prefix}botinfo`) {
    ...
    if(cmd === `${prefix}help`){
    	...
    	.setColor("#35d5f2")
	.setTitle("Command List, Bot owner : Corey#6653")
	.addField("Help", "Shows this embed")
	.addField("Say", "Makes the bot say something")
	.addField("Kick", "Kicks the player from your server")
    .addField("Ban", "Bans the player from your server")
    .addField("Report", "Reports a certain user")
    .addField("Purge","Deletes a certain ammount of messages");
